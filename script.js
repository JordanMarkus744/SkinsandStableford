...
class CourseManager {
  ...
  initEventListeners() {
    ...
    document
      ...
      .addEventListener("click", () => this.showAddCourseModal());
    document
      .querySelector("#addCourseModal .close-modal")
      .addEventListener("click", () => this.closeAddCourseModal());
    document
      .querySelector("#addCourseModal .cancel-btn")
      .addEventListener("click", () => this.closeAddCourseModal());
  ...
  addCourse() {
    ...
    const newCourse = {
      ...
      thumbnail: courseThumbnail
        ? URL.createObjectURL(courseThumbnail)
        : "default-course.jpg",
    };
  ...
  renderCourseTable() {
    ...
    this.courses.forEach((course) => {
      ...
      row
        ...
        .addEventListener("click", () => this.showCourseDetails(course));
      row
        .querySelector(".edit-btn")
        .addEventListener("click", () => this.editCourse(course));
      row
        .querySelector(".delete-btn")
        .addEventListener("click", () => this.deleteCourse(course.id));
  ...
  showCourseDetails(course) {
    ...
    courseInfo.querySelector("#detailCourseLocation").textContent =
      course.location;
    courseInfo.querySelector(
      "#detailCoursePar"
    ).textContent = `Total Par: ${course.totalPar}`;
